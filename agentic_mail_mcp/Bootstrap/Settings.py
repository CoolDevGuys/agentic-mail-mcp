...
def _section_config(prefix: str) -> SettingsConfigDict:
    """Config for a settings section: read ``AGENTIC_MAIL_MCP_<SECTION>_<FIELD>`` from
...
class GmailConfig(BaseSettings):
    model_config = _section_config("AGENTIC_MAIL_MCP_GMAIL_")
...
class DatabaseConfig(BaseSettings):
    model_config = _section_config("AGENTIC_MAIL_MCP_DATABASE_")
    ...
    url: str = "sqlite:///./agentic_mail_mcp.db"
    driver: str = "sqlite"
...
class RailguardsConfig(BaseSettings):
    model_config = _section_config("AGENTIC_MAIL_MCP_RAILGUARDS_")
...
class MCPConfig(BaseSettings):
    model_config = _section_config("AGENTIC_MAIL_MCP_MCP_")

    server_name: str = "Agentic-Mail-MCP"
...
class LLMConfig(BaseSettings):
    model_config = _section_config("AGENTIC_MAIL_MCP_LLM_")
...
class SearchConfig(BaseSettings):
    model_config = _section_config("AGENTIC_MAIL_MCP_SEARCH_")
...
class NotificationsConfig(BaseSettings):
    model_config = _section_config("AGENTIC_MAIL_MCP_NOTIFICATIONS_")
